...
- (void)createTabBar:(CDVInvokedUrlCommand*)command
{
    ...
    [[UITabBar appearance] setTintColor:[UIColor colorWithRed:0.086 green:0.573 blue:0.702 alpha:1.0f]];
    // [[UITabBar appearance] setBarTintColor:[UIColor colorWithRed:175/255.0f green:36/255.0f blue:97/255.0f alpha:1.0f]];
    // #1692b3
...
- (void)createTabBarItem:(CDVInvokedUrlCommand*)command
{
    ...
    NSDictionary *options;
    if ([command.arguments count] > 0) {
        options = [command.arguments objectAtIndex:4];
