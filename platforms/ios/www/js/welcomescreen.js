          ...
          '<div class="welcomescreen-swiper swiper-container">' +
            '<div class="swiper-wrapper">' +
              ...
              '<div class="swiper-slide" {{#if id}}id="{{id}}"{{/if}}>' +
                ...
                '{{else}}' +
                  '{{#if picture}}' +
                    '<div class="welcomescreen-picture"><img src="img/{{picture}}.png" style="width: 100%; height: 100%; background: no-repeat center center fixed; -webkit-background-size: cover; background-size: cover;"></div>' +
                  '{{/if}}' +
                  '{{#if text}}' +
