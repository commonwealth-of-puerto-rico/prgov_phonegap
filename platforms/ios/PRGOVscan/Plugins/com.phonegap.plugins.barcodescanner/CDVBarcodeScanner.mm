...
#define RETICLE_WIDTH    8.0f
#define RETICLE_WIDTH_FINE    2.0f
#define RETICLE_OFFSET   80.0f
...
- (UIImage*)buildReticleImage {
    ...
    /*UIImageView *dot =[[UIImageView alloc] initWithFrame:CGRectMake(150,100,242,79)];
    dot.image=[UIImage imageNamed:@"prgov.png"];
   
    [self.view addSubview:dot];
    */
    
    UIImageView *dot =[[UIImageView alloc] initWithFrame:CGRectMake(150,0,242,79)];
    dot.image=[UIImage imageNamed:@"prgov.png"];
    //dot.center = self.view.center;
    
    
    CGRect myFrame = dot.frame;
    myFrame.origin.x = (self.view.frame.size.width / 2)  - (242 / 2);
    myFrame.origin.y = 90;
    dot.frame = myFrame;
    ...
    */
    ...
    if (self.processor.is1D) {
        ...
        CGContextSetLineWidth(context, RETICLE_WIDTH_FINE);
        CGContextBeginPath(context);
        CGFloat lineOffset = RETICLE_OFFSET+(0.5*RETICLE_WIDTH_FINE);
    ...
    if (self.processor.is2D) {
        ...
        UIColor * color = [UIColor colorWithRed:180/255.0f green:46/255.0f blue:124/255.0f alpha:1.0f];
